...
<body>
    <header>
        <div class="navbar-container" style="border-bottom: 1px solid white;">
            ...
            <div class="body-left">
                <div class="body-left-list">
                    ...
                    <li ><a class="body-left-list-iteam" href="../Adminhome.php"><i class="fas fa-tachometer-alt body-left-list-iteam-icon"></i><b>Trang Chủ</b></a></li>
                        ...
                        <li class="body-left-list-ul-li"><a class="body-left-list-iteam" href="./Nguoidung.php"><i class="fas fa-user body-left-list-iteam-icon"></i></i><b>Người dùng</b></a></li>
                    </ul>
                </div>
            </div>
                        ...
                        while ($row = mysqli_fetch_assoc($query)) {?>
                            <tr>
                                ...
                                <td style="display: flex;">
                                    <a style="margin-right: 10px;" class="btn btn-warning" href="nguoidungindex.php?page_layout=sua&id=<?php echo $row['id']; ?>">Sửa</a>

                                    <a onclick="return Del('<?php  echo $row['username'];?>')" class="btn btn-danger" href="nguoidungindex.php?page_layout=xoa&id=<?php echo $row['id']; ?>">Xóa</a>
                                </td>
                            </tr>
                        <?php } ?>
                </tbody>
