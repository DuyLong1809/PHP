<?php
    ...
    $id = $_GET["id"];
	$sql ="SELECT * FROM quanlyphukien WHERE pk_id = $id";
            ...
            while($row = mysqli_fetch_array($result)){ ?>
                ...
                <div class="main-left-buy">
                    <div class="main-left-buy-sp">
                        ...
                        <!-- Kết hợp hình ảnh và nội dung cho mội phần tử trong slideshow-->
                            <div class="mySlides fade">
                                <img src="../public/IMG/Sanpham/Nike/<?php echo $row['hinhanhpk'] ?>" style="width:100%">
                            </div>
                    ...
                    <div class="main-left-buy-gia">
                        ...
                        <form id="add-to-cart-form" action="Thanhtoan.php?action=add" method="POST">
                            <label style="margin-left: 30px ; font-weight: bold;font-size: 18px;">Số lượng: </label><input style="width: 30px;height: 30px;" type="text" value="1" name="soluong[<?= $row['pk_id']?>]">
                ...
                <div class="main-left-tt">
                    ...
                    <div class="main-left-tt-sp">
                        ...
                        <img  class="main-left-tt-sp-list-img" src="../public/IMG/Sanpham/Nike/<?php echo $row['hinhanhpk'] ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
